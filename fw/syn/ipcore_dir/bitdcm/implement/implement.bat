...
xst -ifn xst.scr
move bitdcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\bitdcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc bitdcm_exdes.ucf bitdcm_exdes

echo 'Running map'
map -timing -pr b bitdcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm bitdcm_exdes -w routed.ncd routed.vhd
cd ..
